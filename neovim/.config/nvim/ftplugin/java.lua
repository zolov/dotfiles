...
wk.add({
	...
	{ "<leader>jb", ":TermExec cmd='mvn clean install -U -X -DskipTests'<CR>", desc = "Clean Install - no tests", nowait = true, remap = false, },
	...
	{ "<leader>jv", mode = { "n" }, "<Cmd>lua require'jdtls'.extract_variable(true)<CR>", desc = "Extract variable", nowait = true, remap = false, },
	{ "<leader>jm", mode = { "v" }, "<Esc><Cmd>lua require'jdtls'.extract_method(true)<CR>", desc = "Extract method", nowait = true, remap = false, },
    ...
    { "<leader>jrd", ":TermExec cmd='mvn spring-boot:run -Pdev'", desc = "Run Dev Profile", nowait = true, remap = false, },
    { "<leader>jrr", springboot.boot_run, desc = "Run", nowait = true, remap = false },
