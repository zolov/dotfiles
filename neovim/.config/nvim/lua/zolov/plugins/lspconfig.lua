...
local function lsp_keymaps(bufnr)
  ...
  keymap(bufnr, "n", "K", "<cmd>Lspsaga hover_doc<CR>", { desc = "Hover", noremap = true, silent = true })
...
M.toggle_inlay_hints = function()
  local is_disabled = not vim.lsp.inlay_hint.is_enabled()
  vim.lsp.inlay_hint.enable(is_disabled)
  vim.notify("Inlay hints " .. (is_disabled and "enabled" or "disabled"), "info")
end
